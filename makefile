...
# - TESTS -
COMPILE_TEST: $(TEST_SOURCES:.o=.cpp)
COMPILE_UNIT: $(UNITTEST_SOURCES:.o=.cpp)
# - DEMOS -
COMPILE_DEMO_BASIC: $(DEMO_BASIC_SOURCES:.o=.cpp)
...
COMPILE_DEMO_SLIDESHOW: $(DEMO_SLIDESHOW_SOURCES:.o=.cpp)
...
COMPILE_DEMO_MOVEMENT: $(DEMO_MOVEMENT_SOURCES:.o=.cpp)
...
COMPILE_DEMO_MANIPULATION: $(DEMO_MANIPULATION_SOURCES:.o=.cpp)
...
COMPILE_DEMOS: COMPILE_DEMO_SLIDESHOW DEMO_MOVEMENT DEMO_MANIPULATION
COMPILE_DEMOS_V: COMPILE_DEMO_SLIDESHOW_V DEMO_MOVEMENT_V DEMO_MANIPULATION_V
COMPILE_DEMOS_D: COMPILE_DEMO_SLIDESHOW_D DEMO_MOVEMENT_D DEMO_MANIPULATION_D
COMPILE_DEMOS_DV: COMPILE_DEMO_SLIDESHOW_DV DEMO_MOVEMENT_DV DEMO_MANIPULATION_DV
# - FULL -
...
DEMOS: DEMO_BASIC DEMO_SLIDESHOW DEMO_MOVEMENT DEMO_MANIPULATION
DEMOS_V: DEMO_BASIC_V DEMO_SLIDESHOW_V DEMO_MOVEMENT_V DEMO_MANIPULATION_V
DEMOS_D: DEMO_BASIC_D DEMO_SLIDESHOW_D DEMO_MOVEMENT_D DEMO_MANIPULATION_D
DEMOS_DV: DEMO_BASIC_DV DEMO_SLIDESHOW_DV DEMO_MOVEMENT_DV DEMO_MANIPULATION_DV
...
UNIT_RUN: UNIT
	$(UNITTEST_EXE)
DEMO_BASIC_RUN: DEMO_BASIC_V
	$(DEMO_BASIC__F)
DEMO_SLIDESHOW_RUN: DEMO_SLIDESHOW_V
	$(DEMO_SLIDESHOW__F)_v.exe Img/1.jpg Img/2.jpg Img/3.jpg Img/4.jpg Img/5.jpg Img/6.jpg
DEMO_MOVEMENT_RUN: DEMO_MOVEMENT_V
	$(DEMO_MOVEMENT_F)_v.exe
DEMO_MANIPULATION_RUN: DEMO_MANIPULATION_V
